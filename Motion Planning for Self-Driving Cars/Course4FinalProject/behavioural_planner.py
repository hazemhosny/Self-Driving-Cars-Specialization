...
class BehaviouralPlanner:
    ...
    def transition_state(self, waypoints, ego_state, closed_loop_speed):
        ...
        if self._state == FOLLOW_LANE:
            ...
            print("----------------------------------------------------------------------------------------")
            print("(1) self goal state :  ", self._goal_state, "In state : ", self._state)
            print("----------------------------------------------------------------------------------------")
            # ------------------------------------------------------------------
        ...
        # state.
            ...
            if closed_loop_speed <= STOP_THRESHOLD:
                ...
                print("----------------------------------------------------------------------------------------")
                print("(2) self goal state :  ", self._goal_state, "In state : ", self._state)
                print("----------------------------------------------------------------------------------------")
            # ------------------------------------------------------------------
        ...
        # the stop sign and transition to the next state.
            ...
            if self._stop_count == STOP_COUNTS:
                ...
                print("----------------------------------------------------------------------------------------")
                print("(3) self goal state :  ", self._goal_state, "In state : ", self._state)
                print("----------------------------------------------------------------------------------------")
                # --------------------------------------------------------------
...
def get_closest_index(waypoints, ego_state):
    ...
    for i in range(len(waypoints)):
        det = math.sqrt((ego_state[0]-waypoints[i][0])**2 + (ego_state[1]-waypoints[i][1])**2)
        if (det < closest_len) :
            closest_len = det
            closest_index = i
    # ------------------------------------------------------------------
